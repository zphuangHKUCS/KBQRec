...
void HIN_Graph::buildYAGOGraphbyDefault()
{
    ...
    YagoReader::readADJ("./data/YAGO/yagoadj.txt", adj);
    YagoReader::readNodeName("./data/YAGO/yagoTaxID.txt",node_name,node_type_name);
    YagoReader::readNodeTypeNum("./data/YAGO/yagoTypeNum.txt", node_type_num);
    YagoReader::readNodeIdToType("./data/YAGO/totalType.txt", node_id_to_type);
    YagoReader::readEdgeName("./data/YAGO/yagoType.txt",edge_name);
